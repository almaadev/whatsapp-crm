...
import { HeartPulse, ShieldAlert, Menu, User, Check, CheckCheck, Clock, X, FileText, Search, Lock } from "lucide-react";
...
const handleSendTemplate = useCallback(async (template, variables) => {
    ...
    const handleToggleChatStatus = async (e) => {
        ...
        try {
            ...
            toast.success(newClosedState ? "Chat Marked as Closed" : "Chat Reopened & Active");
        } catch (error) {
            toast.error("Failed to update Chat Status");
            const revertedHistory = [...selectedChat.history];
            revertedHistory[lastIndex] = { ...lastMessage, isChatClosed: !newClosedState };
                            ...
                            {selectedChat ? (
                                <>
                                    <LeadChatHeader 
                                        ...
                                        isChatActive={!isChatCurrentlyClosed}
