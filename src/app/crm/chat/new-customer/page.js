        ...
        <div className="flex flex-1 w-full h-full relative overflow-hidden flex-col">
          ...
          <div className="flex flex-col items-center justify-center h-full p-4 text-center">
            ...
            <p className="text-slate-500 mt-2">
              You do not have permission to access to new customer.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 outline-none text-sm font-medium text-slate-700 h-[46px]"
                    >
                      <option>New</option>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 outline-none text-sm resize-none"
                    placeholder="Initial remarks (optional)..."
                  ></textarea>
                </div>
              </>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-200 transition-all flex items-center justify-center gap-2 active:scale-[0.98] mt-4"
            >
              {loading ? (
              ...
              <span>
                {existingCustomer ? "Open Chat" : "Save & Start Chat"}
              </span>
            </button>
          </form>
        </div>
  ...
  return (
    <div className="space-y-1.5">
      ...
      <input
        ...
        className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none text-sm transition-all"
      />
    </div>
  );
}
