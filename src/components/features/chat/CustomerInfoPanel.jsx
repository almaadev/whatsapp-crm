...
import { X, User, MapPin, Globe, HelpCircle, DollarSign, FileText, Save, History } from "lucide-react";
  ...
  useEffect(() => {
    if (selectedChat) {
      setFormData({
        ...
        source: selectedChat.source || "Facebook",
    ...
    `}>
      ...
      <div className="flex-1 p-6 overflow-y-auto space-y-6 custom-scrollbar bg-slate-50/50">
        ...
        <div className="space-y-4 bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
          ...
          <div>
            <label className="block text-xs font-bold text-slate-400 uppercase mb-1.5 flex items-center gap-1"><FileText size={12} /> Remarks</label>
            <textarea
              name="remarks"
        ...
        <div className="space-y-4 bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
          <h3 className="text-sm font-bold text-slate-800 border-b border-slate-100 pb-2 mb-2">Daily Follow-up Notes</h3>
          <div>
