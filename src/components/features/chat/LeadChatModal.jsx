    ...
    return (
        <div className="bg-[#f0f2f5] px-4 py-3 border-b border-slate-200 flex items-center justify-between shrink-0 shadow-sm z-20">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
                {showToggle && (
                    <button onClick={onToggle} disabled={isToggling} className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-xs font-bold transition-all shadow-sm ${isChatActive ? 'bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100' : 'bg-slate-100 text-slate-500 border-slate-200 hover:bg-slate-200'}`} title={isChatActive ? "Mark chat as Closed" : "Mark chat as Active"}>
