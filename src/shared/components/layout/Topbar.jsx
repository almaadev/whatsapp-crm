...
export default function Topbar() {
  ...
  const setIsNotificationOpen = useNotificationStore((s) => s.setIsOpen);
  ...
  return (
    <>
      ...
      <div className="h-14 bg-white border-b border-slate-200 shrink-0 flex items-center justify-between px-4 lg:px-6 z-30 relative shadow-[0_1px_2px_rgba(0,0,0,0.02)] select-none">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="p-2 text-slate-500 hover:text-[#00a884] hover:bg-slate-100 rounded-xl relative transition-all cursor-pointer focus:outline-none flex items-center justify-center"
            title="Notifications"
          >
            <Bell size={20} />
            {unreadCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 bg-emerald-500 text-slate-950 text-[9px] font-extrabold rounded-full flex items-center justify-center border-2 border-white shadow-xs">
      ...
      {/* Persistent Notification Right Sidebar Drawer */}
      <NotificationPanel
